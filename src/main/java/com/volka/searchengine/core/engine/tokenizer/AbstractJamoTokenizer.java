 ...
 * @author volka
 */
public abstract class AbstractJamoTokenizer {
     ...
     * @return
     */
    public boolean isOnlyChosungOrEng(String source) {
     ...
     *
     *     각 index 정보는 CHOSUNG, JOONGSUNG, JONGSUNG char[]에 정의한 index 입니다.
     *     하지만 아래 코드에서는 원문이 필요 없기 때문에 합치기 위한 로직은 포함 되어 있지 않습니다.
     * @param source
     * @return
     */
    public abstract JamoToken tokenize(String source);
